                            ...
                            index: (NSUInteger) index
{
    ...
    @try {
        [_imvSong sd_setImageWithURL:artworkUrl placeholderImage:[UIImage imageNamed:kImagePlaceHolder]];
    } @catch (NSException *exception) {
        _imvSong.image = [UIImage imageNamed:kImagePlaceHolder];
    }
    
    _lblSongName.text = strTitle;
